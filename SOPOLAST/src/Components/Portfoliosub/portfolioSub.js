      ...
      <div className="content">
         ...
         <div className="allPort">
            ...
            <div className="portMore">
              ...
              <a href="mailto:chaeeehui@gmail.com" className="aboutText">chaeeehui@gmail.com</a> <br/>
              <img src={github} className="aboutPort"></img>
              <a href="https://github.com/je355" className="aboutText">je355</a> <br/>
              <img src={insta} className="aboutPort"></img>
              <a href="https://www.instagram.com/whywhywwwhy/" className="aboutText">@whywhywwwhy</a> <br/>
            ...
            <div className="moreText">
              ...
              <div className="aboutTitle">
                <p className="eachTitle"> 4개교 연합 해커톤 프론트엔드 </p> <hr/>
                <p className="eachTitle"> React 공부 시작하는 법 A to Z</p><hr/>
                <p className="eachTitle"> Github commit 하는 법 </p><hr/>
                <p className="eachTitle"> 동아리 면접 준비 팁! </p>
              </div>
            </div>

            <div>
              <div className="myStory myCompi"> 배채희님이 모집하는 대회 보기 </div>
              <div className="hrGreen"/>
              <div className="aboutTitle">
                <p className="eachTitle"> 헬로 뉴 월드 같이 나갈 프론트엔드 구합니다. </p>
              </div>
            </div>
         </div> 
        </div>
