        ...
        <div className="mo_portfolio">
         <div className="allPort">
          <div className="portfolio_proflie">
            ...
            <p className="setBio"> " <br/> 후회하기 싫어서 노력하는 개발자 박규민입니다. <br/> " </p>
            </div>
            <div className="portfolio_skill">
              <p className="skillsBio"> My Skills </p>
              <p className="aboutSikll"> React / HTML / CSS / JS / JAVA / Python / C / Mysql</p>
            </div>
            <div className="portfolio-Award">
              <p className="awardBio"> Award </p>
              <p className="aboutAward">  <br/>  <br/>  </p>
            </div>
            <div className="portfolio_AboutMe">
              <p className="aboutMe"> About Me! </p>
              <p className="morePort"> 더 자세한 포트폴리오가 보고 싶다면?</p>
              <a href="https://gilded-emmental-851.notion.site/cdf25b3accb64e51a5be0b25e8db030f" className="herfPort"> 박규민님의 포트폴리오 보러 가기</a>
            </div>
            <div className="portMore">
              ...
              <a href="mailto:kyumin7487@gmail.com" className="aboutText">kyumin7487@gmail.com</a> <br/>
              <img src={github} className="aboutPort"></img>
              <a href="https://github.com/kyumin7487" className="aboutText">kyumin7487</a> <br/>
            ...
            <div className="moreText">
              ...
              <div className="aboutTitle">
                ...
                <p className="eachTitle"> GitHub 프로필 꾸미는법</p><hr/>
                <p className="eachTitle"> 선배와 친해지기 </p><hr/>
                <p className="eachTitle"> 우리 학교 꿀팁</p>
              </div>
            </div>

            <div className="moreContent">
              <div className="myStory myCompi"> 박규민님이 모집하는 대회 보기 </div>
              <div className="hrGreen"/>
              <div className="aboutTitle">
                <p className="eachTitle"> ICT 창업경진대회 같이 나갈 프론트 있나요?? </p>
              </div>
            </div>
         </div> 
        </div>
